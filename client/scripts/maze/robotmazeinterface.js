...
RobotMazeInterface.prototype.renderSpace = function (x,y) {
  ...
  var icons = {
    start: "flaticon flaticon-home152",
    end: "flaticon flaticon-flag106",
    northRobot: "rotate180 flaticon flaticon-down100",
    eastRobot: "flip flaticon flaticon-left202",
    southRobot: "flaticon flaticon-down100",
    westRobot: "flaticon flaticon-left202",
    northRobotStart: "rotate180 flaticon flaticon-down100",
...
RobotMazeInterface.prototype.renderControls = function () {
  ...
  if (this.robot.maze != this.maze) {
    $robot = $('<i class="flaticon flaticon-robots24"></i>').appendTo($actions);
  }
